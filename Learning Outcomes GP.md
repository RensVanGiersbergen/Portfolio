...
For the future I will try to keep track of the third principle: "Product". Another very important thing is the product. The product you make might just be used by thousands, if not millions of people. Keeping it professional and ethically right is very important. So I will give more attention to this when doing my next project.
...
So in the future I will try to analyze a business process as fast as possible to get the perspective of the user of our application. Knowing the users and the process they go through everyday is very useful for us developers. As I explained above. This is something I will go afther directly next project.
